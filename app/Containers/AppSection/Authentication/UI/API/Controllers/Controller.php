...
use App\Containers\AppSection\Authentication\Actions\SayHelloAction;
use App\Containers\AppSection\Authentication\UI\API\Requests\SayHelloRequest;
...
class Controller extends ApiController
{
    ...
    public function sayHello(SayHelloRequest $request)
    {
            ...
            return response()->json(['status'=>'First code in apiato']);
    }
}
